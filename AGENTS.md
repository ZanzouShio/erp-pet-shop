...
## Repository map
- `Ajustes.txt/` — explain what lives here and when agents should edit it.
- `backend/` — explain what lives here and when agents should edit it.
- `backups/` — explain what lives here and when agents should edit it.
- `bkp/` — explain what lives here and when agents should edit it.
- `database-schema-erp.sql/` — explain what lives here and when agents should edit it.
- `dev.js/` — explain what lives here and when agents should edit it.
