...
function App() {
  ...
  // Buscar produtos da API ao carregar
  useEffect(() => {
  ...
  const completeSale = async (paymentMethod: PaymentMethod) => {
    try {
      ...
      const saleData = {
        ...
        customer_id: null // TODO: adicionar seleção de cliente
      };
      ...
      // Atualizar lista de produtos (estoque foi atualizado no backend)
      ...
      alert(`Erro ao registrar venda: ${error instanceof Error ? error.message : 'Erro desconhecido'}`);
    }
  };
