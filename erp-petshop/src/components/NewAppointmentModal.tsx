...
export function NewAppointmentModal(props: NewAppointmentModalProps) {
    ...
    const handleDelete = async () => {
        if (!initialData || !confirm('Tem certeza que deseja cancelar este agendamento?')) return;
        ...
        try {
            ...
            if (initialData) {
                ...
                await appointmentService.update(initialData.id, {
                    ...
                    startTime: `${format(selectedDate, 'yyyy-MM-dd')}T${startHour}:00.000Z`,
                    endTime: localEndTime.toISOString() // Send new End Time!
                });
